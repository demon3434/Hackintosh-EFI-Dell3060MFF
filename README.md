...
### 缺陷
+ 初始安装，使用黑果小兵的镜像 macOS Big Sur 11.5.2 (20G95)，安装完毕未升版本，搜索不到蓝牙音响；升级到11.6.5 (20G527)，蓝牙正常连接音响，但声音时不时地会卡顿，打了[补丁](https://github.com/hackintosh-stuff/ComboJack)仍没有改善
